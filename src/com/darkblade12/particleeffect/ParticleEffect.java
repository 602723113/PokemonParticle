...
public enum ParticleEffect {
	 ...
	 * </ul>
	 */
	// 特殊需求, 直接改为-1, 因为版本固定为1.12.2
	FALLING_DUST("fallingdust", 46, -1, ParticleProperty.REQUIRES_DATA);
...
//				version = Integer.parseInt(Character.toString(PackageType.getServerVersion().charAt(3)));
				...
				Class<?> packetClass = PackageType.MINECRAFT_SERVER
						.getClass(version < 7 && version > 1 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
